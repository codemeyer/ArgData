...
namespace ArgData.Entities
{
    ...
    public class TrackObjectShapeGraphicalElements
    {
        ...
        /// </summary>
        public List<byte> HeaderValues { get; } = new List<byte>();

        /// <summary>
        /// Gets the list of unique elements.
        /// </summary>
        public List<ITrackObjectShapeGraphicalElement> Elements { get; } = new List<ITrackObjectShapeGraphicalElement>();
    ...
    public class TrackObjectShapeGraphicalElementPolygon : ITrackObjectShapeGraphicalElement
    {
        ...
        /// </summary>
        public List<sbyte> Vectors { get; } = new List<sbyte>();
    ...
    public class TrackObjectShapeGraphicalElementLine : ITrackObjectShapeGraphicalElement
    {
        ...
        public byte[] ToBytes()
        {
            return new byte[] { 0xA0, Value1, Value2 };
        }
    }
    ...
    public class TrackObjectShapeGraphicalElementBitmap : ITrackObjectShapeGraphicalElement
    {
        ...
        public byte[] ToBytes()
        {
            return new[] { Indicator, PointIndex, UnknownFlag, ObjectIndex };
        }
    }
    ...
    public class TrackObjectShapeGraphicalElementBitmapExtended : ITrackObjectShapeGraphicalElement
    {
        ...
        public byte[] ToBytes()
        {
            return new[] { Indicator, PointIndex, UnknownFlag, ObjectIndex, AdditionalData1, AdditionalData2 };
        }
    }
