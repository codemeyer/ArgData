...
internal static class ObjectShapesReader
{
    ...
    {
        shapeData.HeaderValue1 = BitConverter.ToInt16([data[0], data[1]], 0);
        shapeData.ScaleValueOffset = BitConverter.ToInt16([data[2], data[3]], 0);
        shapeData.HeaderValue2 = BitConverter.ToInt16([data[4], data[5]], 0);
        shapeData.GraphicalElementsOffset = BitConverter.ToInt16([data[6], data[7]], 0);
        shapeData.HeaderValue3 = BitConverter.ToInt16([data[8], data[9]], 0);
        shapeData.PointDataOffset = BitConverter.ToInt16([data[10], data[11]], 0);
        shapeData.HeaderValue4 = BitConverter.ToInt16([data[12], data[13]], 0);
        shapeData.VectorDataOffset = BitConverter.ToInt16([data[14], data[15]], 0);

        shapeData.HeaderValue5 = BitConverter.ToInt16([data[16], data[17]], 0);
        shapeData.HeaderData5 = GetHeaderData5(data);

        shapeData.Offset5 = BitConverter.ToInt16([data[28], data[29]], 0);

        shapeData.HeaderValue6 = BitConverter.ToInt16([data[30], data[31]], 0);
