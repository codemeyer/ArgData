...
public class MediaContainerFileReader
{
    ...
    private static MediaFileItem ItemFactory(short type)
    {
        return type switch
        {
            1768 => new MediaItem1768(),
            1769 => new ImageItem1769(),
            1774 => new ImageItem1774(),
            1776 => new PaletteItem(),
            _ => throw new ArgumentOutOfRangeException(nameof(type), type, $"Unknown media file item type {type}")
        };
    }
