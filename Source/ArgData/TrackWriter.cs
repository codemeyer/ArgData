...
public class TrackWriter
{
    ...
    private static byte[] GetTrackDataHeaderBytes(TrackSectionHeader trackDataHeader, TrackSettings settings)
    {
        ...
        {
            header.AddBytes([3, 0, 8, 0, settings.KerbUpperColor, 0, settings.KerbLowerColor, 0, 8, 0]);
        }
        else
        {
            header.AddBytes([4, 0, 8, 0, settings.KerbUpperColor, 0, settings.KerbLowerColor, 0, 8, 0,
